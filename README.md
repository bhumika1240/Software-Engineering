...
- **[Full Ethical Framework](./docs/docs/ETHICS.md)**: Detailed breakdown of safety and privacy.
- **[Code of Conduct](./CODE_OF_CONDUCT.md)**: Team rules and collaboration standards.
